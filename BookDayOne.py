...
def broker_overview_comparison():
    ...
    The choice of your personal depot broker is crucial for anyone starting in wealth building or even for experienced investors looking for a new partner. Each broker offers a unique set of features, fees, and platforms, catering to different investor needs. While some may prioritize low fees, others might look for extensive research tools or a wide range of available securities. Here  you can select the different brokers and also connect to their landing page:
    """)
...
def main():
    ...
    if page_selection == "Account Overview":
        ...
        analyse(df)
    elif page_selection == "Financial Forecast":
        recommendation_page()
